...
export class UpdatePersonDto {
  ...
  @ApiPropertyOptional({ name: 'phone', description: 'Phone', example: '+33600000000', pattern: '/^(\+\d{11})$/' })
  @IsOptional()
  @IsPhoneNumber('FR')
  phone?: string;
  ...
  @ApiPropertyOptional({ name: 'isManager', description: 'Flag to know if this person is a manager', example: false })
  @IsOptional()
  @IsBoolean()
  isManager?: boolean;
